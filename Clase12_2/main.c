...
int main()
{
    ...
    //pantalla_altaForzada(array,QTY,"Vernal","Cerrito 300",3000,0);
    ...
    do
    {
        ...
        switch(menu)
        {
            ...
            case 7:
                ...
                break;
            case 8:
                listarprecionombre(array, QTY);
                break;
            case 10:
                listarPrecioMil(array,QTY);
                break;
            case 11:
                promedioPrecio(array,QTY);
                break;
            case 12:
                listarPantallaSupProm(array,QTY);
                break;
            case 13:
                promedioDias(contrataciones, LEN_CONT);
                break;
            case 14:
                listarPantalla(contrataciones,array,QTY,LEN_CONT);
                break;
            case 15:
                listarPantallaMasUnaP(array, contrataciones, QTY, LEN_CONT);
                break;
        }
